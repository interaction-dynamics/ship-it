  ...
  return (
    <html lang="en">
      <body>
        ...
        >
          <div className="flex flex-col items-center justify-center min-h-screen px-4 py-12 bg-linear-to-b ">
            <div className="w-full max-w-md space-y-8 text-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  We&apos;re experiencing technical difficulties with the entire application. Please
